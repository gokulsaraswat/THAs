// let questions = [
// 		{
// 		question: "Why kenny is sensitive?",
// 		option1: "Happy",
// 		option2: "Sad",
// 		option3: "BrySad",
// 		option4: "1 none",
...
// 	{
// 		question: "Why kenny is not sensitive?",
// 		option1: "Happy",
// 		option2: "Sad",
// 		option3: "BrySad",
// 		option4: "Noney 2y",
...
// 	{
// 		question: "Why kenny is not such a good name?",
// 		option1: "Happy",
// 		option2: "Sad",
// 		option3: "BrySad",
// 		option4: "Nonee",
...
// 	{
// 		question: "How to shut himture's accent?",
// 		option1: "We love it ",
// 		option2: "Lets listen more",
// 		option3: "He is awesome",
// 		option4: "He is inevitable",
// 	},
...
stats.innerHTML = `<span>01/${questions.length}</span>`
...
// score maybe not correct answer
sc.innerHTML = "<p>Your Score</p><h3>0</h3>";
...
function check(e, question, box) {
	...
	if (question.correct == e.target.value) {
		...
		if (score <= 5) {
			...
			h1.innerHTML = "Congo !! You cleared more than 50% Passed "
		}
	...
	gameActive = false;
	setTimeout(() => {
		box.style.transform = "translateX(-190%)";
		setTimeout(() => {
			box.style.transform = "translateZ(-15px)"
			box.style.zIndex = "-1";
		}, 300);
		answered++;
		stats.innerHTML = "<span>" + (answered == 9 ? "" : "0") + (answered + 1) + "/"+ total +"</span>"
		if (answered == total) {
